...
<div className="card   lg:p-12 border w-2/3 ">
  <form onSubmit={handleSignUp} className="card-body lg:w-2/3 mx-auto">
    ...
    <div className="form-control mt-6">
      <button type='submit' className="btn btn-primary border-none hover:bg-black  bg-red-500 text-white">Sign Up</button>
    </div>
  </form>
      <div className="text-center">
        ...
        <p className='mt-4'>Already have an account? <Link to={'/login'} className='text-red-500 font-semibold'>Log In</Link></p>
      </div>
</div>
</div>
</div>
